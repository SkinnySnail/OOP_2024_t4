...
public class DSKH {
    ...
    public void createSampleData() {
        if (khachHang.isEmpty()) {
            DiaChi diachi = new DiaChi("123", "Lê Lợi", "Quận 1", "TP.HCM");
            khachHang.add(new KhachHang("Nguyễn Văn A", LocalDate.of(1990, 1, 15), "a@gmail.com", "Nam", diachi,
                    "KH001", "VIP", 1000));
            khachHang.add(new KhachHang("Trần Thị B", LocalDate.of(1995, 5, 20), "b@gmail.com", "Nữ", diachi,
                    "KH002", "Thường", 500));
        }
    }
